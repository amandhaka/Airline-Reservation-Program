...
{  public:
	...
	void put()             // display details of tickets
	{
	    ...
	    cout<<"\n\t Fare(Including Tax and others) : "<<fare;
	}
...
{   
	...
	{   fin.read((char*)&p1,sizeof(p1));
	 ...
	 fare=8*tdistance;
	 cout<<"Select if you are applicable for any concession"<<endl;
	 cout<<"\t\t\t1.Defence Category \n\t\t\t\2.Below Poverty Line \n\t\t\t3.Handicapped \n\t\t\t4.None of the above \n\t\t\t ";
	 int c;
	 cin>>c;
	 int discount=0;
	 switch(c)
...
int main()
{
	...
	cout << " \" A I R   S E R V I C E S \"";
	cout<<endl<<"Presented to you by : "<<endl<<" Aman Dhaka "<<endl<<" Saubhagya Handoo"<<endl<<" Raghav Chawla"<<endl;
     int c, d;
   ...
   for (c = 1; c <= 32767; c++)
	...
	else if (den == 1)
	{
		...
		while (k < 4)
		{
			...
			cout << "..................................................................";
			cout << "\n\n\n";
			cout << "\t\tThis Software is HIGHLY CONFIDENTIAL.....";
			cout << "\n\n\n\t\t\tEnter the password......";
			char p[11], pass[11];
